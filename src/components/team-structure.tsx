              ...
              <Card className="h-full relative overflow-hidden bg-white/80 dark:bg-background/80 backdrop-blur-sm border-green-50 dark:border-green-900/30 shadow-lg hover:shadow-xl hover:shadow-green-500/5 transition-all duration-300">
                ...
                <CardContent className="relative p-5 flex flex-col items-center text-center h-full">
                  ...
                  <div className="space-y-2 mb-4">
                    ...
                    <p className="text-lg font-semibold text-gray-800 dark:text-gray-200">{techie.title}</p>
                  </div>
                  
                  <div className="mt-auto">
                    <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
                      {techie.years} students who are eager to learn and contribute
                    </p>
                  </div>
              ...
              <Card className="h-full relative overflow-hidden bg-white/80 dark:bg-background/80 backdrop-blur-sm border-green-50 dark:border-green-900/30 shadow-lg hover:shadow-xl hover:shadow-green-500/5 transition-all duration-300">
                ...
                <CardContent className="relative p-5 flex flex-col items-center text-center h-full">
                  ...
                  <div className="space-y-2 mb-4">
                    ...
                    <p className="text-lg font-semibold text-gray-800 dark:text-gray-200">{explorer.title}</p>
                  </div>
              ...
              <Card className="h-full relative overflow-hidden bg-white/80 dark:bg-background/80 backdrop-blur-sm border-green-50 dark:border-green-900/30 shadow-lg hover:shadow-xl hover:shadow-green-500/5 transition-all duration-300">
                ...
                <CardContent className="relative p-5 flex flex-col items-center text-center h-full">
                  ...
                  <div className="space-y-2 mb-4">
                    ...
                    <p className="text-lg font-semibold text-gray-800 dark:text-gray-200">{advisor.title}</p>
                  </div>
              ...
              <Card className="h-full relative overflow-hidden bg-white/80 dark:bg-background/80 backdrop-blur-sm border-green-50 dark:border-green-900/30 shadow-lg hover:shadow-xl hover:shadow-green-500/5 transition-all duration-300">
                ...
                <CardContent className="relative p-5 flex flex-col items-center text-center h-full">
                  ...
                  <div className="space-y-2 mb-4">
                    ...
                    <p className="text-lg font-semibold text-gray-800 dark:text-gray-200">{mentor.title}</p>
                  </div>
                  
                  <div className="mt-auto">
                    <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
                      {mentor.years} who provide industry insights and connections
                    </p>
                  </div>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h4 className="font-medium text-gray-800 dark:text-gray-200 mb-1">Knowledge Transfer</h4>
                        <p className="text-sm text-gray-600 dark:text-gray-400">
                          Mentors guide Advisors, who guide Explorers, who guide Techies
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="w-2 h-2 rounded-full bg-green-500 mt-2 flex-shrink-0" />
                      <div>
                        <h4 className="font-medium text-gray-800 dark:text-gray-200 mb-1">Progressive Responsibility</h4>
                        <p className="text-sm text-gray-600 dark:text-gray-400">
                          Members take on more responsibility as they move up the ranks
                        </p>
                      </div>
                    </div>
                  </div>
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      <div className="w-2 h-2 rounded-full bg-green-500 mt-2 flex-shrink-0" />
                      <div>
                        <h4 className="font-medium text-gray-800 dark:text-gray-200 mb-1">Sustainable Growth</h4>
                        <p className="text-sm text-gray-600 dark:text-gray-400">
                          As students graduate, they become mentors, creating a continuous cycle
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="w-2 h-2 rounded-full bg-green-500 mt-2 flex-shrink-0" />
                      <div>
                        <h4 className="font-medium text-gray-800 dark:text-gray-200 mb-1">Cross-College Collaboration</h4>
                        <p className="text-sm text-gray-600 dark:text-gray-400">
                          Each role includes members from different colleges, fostering collaboration
                        </p>
                      </div>
                    </div>
                  </div>
