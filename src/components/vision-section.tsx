...
import { Lightbulb, Users, Code, Globe, Sparkles, ArrowRight, Target } from "lucide-react"
  ...
  const visionPoints = [
    {
      ...
      title: "Innovation",
      description: "Fostering a culture of innovation and creative problem-solving across colleges"
    },
    {
      icon: <Users className="h-5 w-5" />,
      title: "Collaboration", 
      description: "Breaking down silos between college communities to work together"
    },
    {
      icon: <Code className="h-5 w-5" />,
      title: "Learning in Public",
      description: "Encouraging students to share their learning journey and build in the open"
    },
    {
      icon: <Globe className="h-5 w-5" />,
      title: "Ecosystem Building",
      description: "Creating a thriving tech ecosystem in Mangalore for the next generation"
    },
  ]
      ...
      <div className="container relative mx-auto px-6">
        ...
        >
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-green-50 dark:bg-green-900/20 border border-green-100 dark:border-green-800/50 mb-5">
            ...
            <span className="text-sm font-medium text-green-600 dark:text-green-300">Our Vision & Mission</span>
          </div>
          
          <h2 className="md:text-4xl font-bold mb-12 text-gray-800 dark:text-gray-200">
            Building Tomorrow's <span className="text-green-600 dark:text-green-400">Tech Ecosystem</span>
          </h2>
