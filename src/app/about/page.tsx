            ...
            <div className="grid md:grid-cols-2 gap-8">
              <Card className="p-6">
                ...
                <p className="text-muted-foreground">
                  To create a thriving tech ecosystem in Mangalore where
                  students with ideas can access the best resources in the city,
                  fostering innovation and collaboration across college
                  boundaries.
                </p>
              </Card>
              <Card className="p-6">
                ...
                <p className="text-muted-foreground">
                  We connect college tech communities to learn and build
                  together in public, breaking down silos between institutions
                  and creating a unified tech community that empowers students
                  to grow through collaborative projects and knowledge sharing.
                </p>
              </Card>
            </div>
          </section>
          ...
          <section>
            ...
            <Card className="p-6">
              ...
              <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                ...
                <li>
                  Develop a self-sustaining community model that can be
