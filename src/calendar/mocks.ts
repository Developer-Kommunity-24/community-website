...
const mockGenerator = (numberOfEvents: number): IEvent[] => {
  const result: IEvent[] = [
    {
      id: "1204",
      startDateTime: new Date("2025-09-20T00:00:00-03:00").toISOString(),
      endDateTime: new Date("2025-09-20T23:59:00-03:00").toISOString(),
      title: "My wedding :)",
      color: "red",
  ...
  const currentEvent = {
    ...
    endDateTime: new Date(now.getTime() + 30 * 60000).toISOString(),
