...
export const individualSchema = z.object({
  ...
  interests: z.string().min(50, "Please tell us about your interests (minimum 50 characters)."),
  motivation: z.string().min(100, "Please tell us why you want to join DK24 (minimum 100 characters)."),
})
...
export const collegeSchema = z.object({
  ...
  communityActivities: z.string().min(100, "Please describe the current activities (minimum 100 characters)."),
  expectations: z.string().min(100, "Please tell us what you expect from joining DK24 (minimum 100 characters)."),
})
